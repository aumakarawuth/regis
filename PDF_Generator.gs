...
function _collegeSeal() {
  // ตราวิทยาลัยแบบวงกลม (ตามที่ปรากฏในแบบฟอร์มจริง) — จำลองด้วย SVG
  return '<svg class="seal" viewBox="0 0 200 216" xmlns="http://www.w3.org/2000/svg">' +
    '<defs>' +
      '<path id="sealTopArc" d="M 26,108 A 76,76 0 0 1 174,108" fill="none"/>' +
      '<path id="sealBotArc" d="M 38,142 A 64,64 0 0 0 162,142" fill="none"/>' +
    '</defs>' +
    '<circle cx="100" cy="100" r="94" fill="none" stroke="#000" stroke-width="1.8"/>' +
    '<circle cx="100" cy="100" r="88" fill="none" stroke="#000" stroke-width="1"/>' +
    '<g stroke="#000" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">' +
      '<path d="M100,42 C94,50 92,56 100,62 C108,56 106,50 100,42 Z" fill="#000"/>' +
      '<path d="M92,62 L108,62 L104,80 L96,80 Z" fill="#000"/>' +
      '<line x1="100" y1="80" x2="100" y2="106"/>' +
      '<path d="M88,106 C88,117 112,117 112,106"/>' +
    '</g>' +
    '<g stroke="#000" stroke-width="1.3" fill="none">' +
      '<circle cx="100" cy="120" r="15"/>' +
      '<circle cx="100" cy="120" r="3.5" fill="#000"/>' +
      '<line x1="103.5" y1="120" x2="115" y2="120"/>' +
      '<line x1="102.5" y1="122.5" x2="110.6" y2="130.6"/>' +
      '<line x1="100" y1="123.5" x2="100" y2="135"/>' +
      '<line x1="97.5" y1="122.5" x2="89.4" y2="130.6"/>' +
      '<line x1="96.5" y1="120" x2="85" y2="120"/>' +
      '<line x1="97.5" y1="117.5" x2="89.4" y2="109.4"/>' +
      '<line x1="100" y1="116.5" x2="100" y2="105"/>' +
      '<line x1="102.5" y1="117.5" x2="110.6" y2="109.4"/>' +
    '</g>' +
    '<text font-size="10.5" font-weight="700" letter-spacing="0.3">' +
    ...
    '</text>' +
    '<text x="100" y="206" font-size="7" text-anchor="middle">\u0e40\u0e02\u0e15\u0e1a\u0e32\u0e07\u0e01\u0e2d\u0e01\u0e19\u0e49\u0e2d\u0e22 \u0e01\u0e23\u0e38\u0e07\u0e40\u0e17\u0e1e\u0e21\u0e2b\u0e32\u0e19\u0e04\u0e23</text>' +
  '</svg>';
}
