-- ============================================================
-- 0012_guardian_address.sql
--
-- The printed form has a "ที่อยู่" (address) blank in the guardian
-- section that was always left empty — apply.html never collected it
-- and guardians had no column for it. Adds the column and wires it
-- through submit_application().
-- ============================================================
